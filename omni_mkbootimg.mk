...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	$(hide) curl -T $(PRODUCT_OUT)/${TTYP}-${TDEV}_${d}${TIMG} -u sub77:${TPWD} ftp://uploads.androidfilehost.com --ftp-create-dirs
	$(hide) curl -T $(PRODUCT_OUT)/${TTYP}-${TDEV}_${d}${TTAR} -u sub77:${TPWD} ftp://uploads.androidfilehost.com --ftp-create-dirs
	@echo -e ${CL_CYN}"uploaded omnirom recovery image to afh: ${TTYP}-${TDEV}_${d}${TIMG}"${CL_RST}
	@echo -e ${CL_CYN}"uploaded omnirom recovery image to afh: ${TTYP}-${TDEV}_${d}${TTAR}"${CL_RST}
